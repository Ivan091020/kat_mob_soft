...
namespace kat_mob_soft.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(IAccountService accountService, IWebHostEnvironment appEnvironment)
        {
        ...
        public IActionResult SendMessage([FromBody] ContactMessageModel _)
        {
